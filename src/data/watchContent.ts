...
export interface WatchContent {
  ...
  year: number;
  rating: number;
  runtime: number; // in minutes for movies, avg episode length for series
  genre: string[];
  plot: string;
  poster: string;
  backdrop: string;
...
export const watchContent: WatchContent[] = [
  ...
  },
  {
    ...
    poster: 'https://images.unsplash.com/photo-1497215728101-856f4ea42174?w=300&h=450&fit=crop',
  ...
  },
  {
    ...
    poster: 'https://images.unsplash.com/photo-1472457897821-70d3819a0e24?w=300&h=450&fit=crop',
    backdrop: 'https://images.unsplash.com/photo-1419242902214-272b3f66ee7a?w=1920&h=1080&fit=crop',
    isHot: true,
    seasons: [
      {
