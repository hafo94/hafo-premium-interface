  ...
  return (
    <div className="min-h-screen bg-background text-foreground relative overflow-hidden">
      ...
      <main className="relative z-10 flex flex-col items-center justify-center min-h-[60vh] px-6">
        <div className="text-nipflix mb-6">
          <Film className="w-20 h-20" strokeWidth={1.5} />
        </div>
        <h1 className="text-4xl md:text-5xl font-bold mb-4 text-center">Watch</h1>
        <p className="text-foreground/60 text-lg text-center max-w-md">
          Your movies and series collection. Browse and stream your favorite content.
        </p>
      </main>
    </div>
  );
