...
const RetroGaming = () => {
  return (
    <div className="min-h-screen bg-background text-foreground relative overflow-hidden">
      <AnimatedBackground accentColor="--retro" />
      ...
      <main className="relative z-10 flex flex-col items-center justify-center min-h-[60vh] px-6">
        <div className="text-retro mb-6">
          <Gamepad2 className="w-20 h-20" strokeWidth={1.5} />
        </div>
        <h1 className="text-4xl md:text-5xl font-bold mb-4 text-center">Retro Gaming</h1>
        <p className="text-foreground/60 text-lg text-center max-w-md">
          Relive the classics. Play your favorite retro games.
        </p>
      </main>
    </div>
  );
